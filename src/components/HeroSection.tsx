...
const HeroSection = () => {
  ...
  return (
    <div className="relative w-full h-full bg-gradient-to-r from-dseza-light-primary/90 to-dseza-light-accent/80 dark:from-dseza-dark-primary/90 dark:to-dseza-dark-accent/80">
